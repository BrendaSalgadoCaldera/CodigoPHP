...
?>
  <?php
  echo "<br>YANBAL tiene los productos que tu piel te exige";
  ?>
  <?php
  echo "<br>A";
  echo "<br>B";
  echo "<br>C";
   ...
   <?php
   echo "<br>","<strong> Este proyecto es enfocado a la empresa Yanbal </strong>";
?>
<?php
  echo "<p>Yanbal es una empresa en la que puedes confiar</p>";
  // This is a single-line comment
  echo "<p> La empresa Yanbal cuenta con personal altamente calificado</p>";
  echo "<p>Yanbal es una empresa de gran escala</p>";
?>
<?php
  echo "<p> Se manejan grandes tecnologias </p>";
  /*
  This is a multi-line comment block
  that spans over
  multiple lines
  */
  echo "<p>Con los productos de yanbal tu cuerpo de lo agradecera</p>";
  echo "<p>Tecnoserver aumentara las ganacias de tu empresa</p>";
?>
  </body>
</html>
...
?>
<?php
define("Tecnoserver", "La empresa tiene las puertas abiertas para satisfacer sus necesidades", false);
echo "<br>",Yanbal;

// Outpusts "La empresa tiene las puertas abiertas para satisfacer sus necesidades"
?>

<?php
$string1 = "Yanbal"; //double quotes
$string2 = 'La empresa que puede ayudar a tu piel a sentirse linda';  //single quotes
...
echo "<br>","<br>","mostrando el el nombre encontrado en la posicion 1 del arreglo names","=", $names[1]; //Outputs "Estefany"
echo "<br>","<br>","mostrando el el nombre encontrado en la posicion 0 del arreglo names","=", $names[0]; //Outputs "Estefany"
echo "<br>","<br>","mostrando el el nombre encontrado en la posicion 2 del arreglo names","=", $names[2]; //Outputs "Estefany"
...
echo "<br>","<br>","$myArray[0] tiene $myArray[2]años y utiliza $myArray[1]"; 
 ...
 // Outputs "Brenda tiene 16 años y es ingeniera en infraestructura de la empresa Tecnoserver"
?>
<?php

$people = array("Juan"=>"16", "Marina"=>"16",
"Brenda"=>"16");

echo "<br>","<br>","Se muestra la edad de una de las ingenieras de la empresa Yanbal","=", $people['Brenda']; // Outputs 18"
?>

<?php
$people = array(
  'online'=>array('Juan', 'Brenda'),
  'offline'=>array('Alejandra', 'Marina'),
  'away'=>array('Estefany', 'David')
);

echo "<br>","<br>","mostrando el nombre de la posicion 0, de online","=", $people['online'][0]; //Emite "Juan"

echo "<br>","<br>","mostrando el nombre de la posicion 1, de away","=", $people['away'][1];//David
?>
...
<?php
$names = array("Marina", "Alejandra", "Brenda");
foreach ($names as $name) {
  echo "Ingenieras:", $name.'<br />';
}
...
<?php
function sayHello() {
  echo "<br>","mostrando resultado de funcion =","Yanbal";
}
...
<?php
require 'config.php';
echo '<img src="'.$image_path.'yanbal.jpeg" >';
?>
